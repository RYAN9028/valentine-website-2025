...
const CONFIG = {
    ...
    valentineName: "SREYAKUTTTYYYYYYYY <3",
    ...
    colors: {
        ...
        backgroundEnd: "#E5D4ED",        // Gradient end (should complement backgroundStart)
        buttonBackground: "#C49BBB",     // Button color (should stand out against the background)
        buttonHover: "#FDE2FF",          // Button hover color (slightly lighter than buttonBackground)
    ...
    music: {
        ...
        musicUrl: "https://res.cloudinary.com/dlhujq5y5/video/upload/v1770452518/maula-mere-maula-lyrics-roopkumar-rathod-aankhein-teri-kitni-haseen_SXkXUADz_hn3h3k.mp3", // Music streaming URL
